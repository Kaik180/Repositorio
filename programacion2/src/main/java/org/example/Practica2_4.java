...
public class Practica2_4 {
    public static void main(String[] args) {
        ...
        do {
            try {
                System.out.println("Introduce el primer número (3 cifras):");
                numero1 = teclado.nextInt();
                System.out.println("Introduce el segundo número (3 cifras):");
                numero2 = teclado.nextInt();

                // comprar que los numeros son legibles y es lo que pedimos
                if (numero1 < -999 || numero1 > 999 || numero2 < -999 || numero2 > 999) {
                    ...
                    // Separación de dígitos por string
                    String numero_string = Integer.toString(Math.abs(numero2));
                    ...
                    control = true; // para salir del bucle
                }
            } catch (Exception e) {
                System.out.println("Error de formato");
                teclado.nextLine(); // Limpia la catche
            }
        } while (!control); // se repite mientras no salga del bucle
